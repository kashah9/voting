...
public class VotingController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			System.out.println("Debug VotingController: " + ub.getMember_id());
			String sql = "select * from election_votes where election_id=" + electionId + " AND voter_id="
			...
			while (rs.next()) {
				...
				sql = "insert into election_votes values(" + electionId + "," + voter + ",'" + positionName + "',"
						+ vote + ");";
